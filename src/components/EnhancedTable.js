...
export default function EnhancedTable(props) {
  ...
  const handleLeadClick = (lead, event) => {
    ...
    if (event.target.checked) {
      ...
      const newArray = leadsArray.filter(
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar addLead={props.addLead} leadsArray={leadsArray} company={props.company} website={props.website} listArray={listArray} userId={props.userId} numSelected={selected.length} />
